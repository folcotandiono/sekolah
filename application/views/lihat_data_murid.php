                ...
                <!-- /.col -->
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="nama" id="nama" value='<?php echo $murid[0]->nama ?>' readonly>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="password">Password:</label>
                      <input type="text" class="form-control" name="password" id="password" value='<?php echo $murid[0]->password ?>' readonly>
                    </div>
                  </div>
                  <!-- <div class="col-md-12">
                    <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="nisn" id="nisn" value="<?php echo $murid[0]->nisn ?>" readonly>
                    </div>
                  </div>
