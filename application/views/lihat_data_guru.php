        ...
        <div class="col-md-12">
          <div class="box">
            ...
            <div class="box-body" style="">
              <div class="row">
                <!-- /.col -->
                  <input type="text" class="form-control" name="id" id="id" style="display:none" value="<?php echo $guru[0]->id ?>" readonly>
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="nama">Nama:</label>
                      <input type="text" class="form-control" name="nama" id="nama" value="<?php echo $guru[0]->nama ?>" readonly>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="password">Password:</label>
                      <input type="text" class="form-control" name="password" id="password" value="<?php echo $guru[0]->password ?>" readonly>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
