                ...
                <!-- /.col -->
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="tahunAjaranTahun" readonly>
                    </div>
                  </div>
...
<script type="text/javascript">
  ...
  $("#simpan").click(function() {
    $.ajax({
      type: "POST",
      url: "<?php echo base_url() ?>index.php/home/tambahDataKelasSimpan",
      data: {
        nama : $("#nama").val(),
      ...
      complete: function(result){
        console.log("haha");
        toastr.success('Data kelas berhasil ditambah');
        $("#nama").val("");
        $("#tahunAjaranId").val("");
        $("#tahunAjaranTahun").val("");
      }
  });
});
</script>
