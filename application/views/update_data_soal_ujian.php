        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Update Data Soal Ujian</h3>
                ...
                <form action="<?php echo base_url() ?>index.php/home/updateDataSoalUjianSimpan" id="form" method="post" enctype='multipart/form-data'>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="judulUjianId" value="<?php echo $soal_ujian[0]->id_judul_ujian ?>" name="id_judul_ujian" style="display:none">
                      <input type="text" class="form-control" id="judulUjianNama" value="<?php echo $soal_ujian[0]->nama_judul_ujian ?>" readonly>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="soalTulisan" name="soal_tulisan" rows="3"><?php echo $soal_ujian[0]->soal_tulisan ?></textarea>
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="kunciJawaban" value="<?php echo $soal_ujian[0]->kunci_jawaban ?>" name="kunci_jawaban">
                    </div>
                  </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    var pilihanJawabanTulisan = <?php echo $soal_ujian[0]->pilihan_jawaban_tulisan ?>;
    ...
    var pilihanJawabanGambar = <?php echo $soal_ujian[0]->pilihan_jawaban_gambar ?>;
...
//       //   // jenis_soal_ujian : $("#jenisSoalUjianNama").val(),
