                    ...
                    <table class="table table-hover">
                      ...
                      <?php foreach ($results as $data) { ?>
                        <tr>
                          ...
                          <td> <a href="<?php echo base_url() . "index.php/home/updateDataTahunAjaran/".$data->id ?>" class="btn btn-warning">Update</a>
                            <a href="<?php echo base_url() . "index.php/home/hapusDataTahunAjaran/".$data->id ?>" class="btn btn-danger">Delete</a> </td>
                        </tr>
                      <?php } ?>
                    </table>
                  <?php } else { ?>
