        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Tambah Data Materi Pelajaran</h3>
            ...
            <div class="box-body" style="">
              <div class="row">
                <!-- /.col -->
                <form action="<?php echo base_url() ?>index.php/home/tambahDataMateriPelajaranSimpan" id="form" method="post" enctype='multipart/form-data'>
                  <div class="col-md-12">
